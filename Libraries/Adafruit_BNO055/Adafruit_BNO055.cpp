...
*/
/**************************************************************************/
imuAdafruit::Vector<3> Adafruit_BNO055::getVector(adafruit_vector_type_t vector_type)
{
  imuAdafruit::Vector<3> xyz;
  uint8_t buffer[6];
  memset (buffer, 0, 6);
...
*/
/**************************************************************************/
imuAdafruit::Quaternion Adafruit_BNO055::getQuat(void)
{
  uint8_t buffer[8];
  memset (buffer, 0, 8);
  ...
  imuAdafruit::Quaternion quat(scale * w, scale * x, scale * y, scale * z);
  return quat;
}
...
bool Adafruit_BNO055::getEvent(sensors_event_t *event)
{
  ...
  imuAdafruit::Vector<3> euler = getVector(Adafruit_BNO055::VECTOR_EULER);
